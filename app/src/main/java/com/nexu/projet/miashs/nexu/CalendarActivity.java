...
import static com.nexu.projet.miashs.nexu.R.layout.calendrier;
...
public class CalendarActivity extends AppCompatActivity {
    ...
    private List<Calendar> getDisabledDays() {
        Calendar firstDisabled = Date.getCalendar();
        firstDisabled.add(Calendar.DAY_OF_MONTH, 2);

        Calendar secondDisabled = Date.getCalendar();
        secondDisabled.add(Calendar.DAY_OF_MONTH, 1);

        Calendar thirdDisabled = Date.getCalendar();
