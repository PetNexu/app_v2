...
public class PageObjet extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, MainActivity.class);
        ...
        @Override
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, PageInventaire.class);
            startActivity(intentLoad);
        }
        });
        ...
        @Override
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, PageCalendrier.class);
            startActivity(intentLoad);
        }
        });
        ...
        @Override
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, PageProgramme.class);
            startActivity(intentLoad);
        }
        });
        ...
        @Override
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, PageMap.class);
            startActivity(intentLoad);
        }
        });
        ...
        @Override
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, PageStatistiques.class);
            startActivity(intentLoad);
        }
        });
        ...
        @Override
        public void onClick(View view) {
            Intent intentLoad = new Intent(PageObjet.this, PageCompte.class);
            startActivity(intentLoad);
        }
        });
