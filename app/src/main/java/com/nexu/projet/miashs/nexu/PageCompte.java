    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        buttonAccueil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, MainActivity.class);
        ...
        buttonInventaire.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, PageInventaire.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonCalendrier.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, PageCalendrier.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonProgramme.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, PageProgramme.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, PageMap.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonStatistiques.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, PageStatistiques.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonCompte.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageCompte.this, PageCompte.class);
                startActivity(intentLoad);
            }
        });
