...
public class PageParametresCompte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.parametres_compte);
        ...
        buttonAccueil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, MainActivity.class);
        ...
        buttonInventaire.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, PageInventaire.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonCalendrier.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, PageCalendrier.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonProgramme.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, PageProgramme.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, PageMap.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonStatistiques.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, PageStatistiques.class);
                startActivity(intentLoad);
            }
        });
        ...
        buttonCompte.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentLoad = new Intent(PageParametresCompte.this, PageCompte.class);
                startActivity(intentLoad);
            }
        });
